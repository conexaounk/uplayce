...
export default function HomePage() {
  ...
  return <div className="h-full overflow-hidden flex flex-col lg:flex-row gap-6 p-6">
    {/* Main Content */}
    <div className="flex-1 lg:col-span-8 overflow-y-auto scrollbar-hide pb-32 space-y-8 pr-2">
      {/* Hero Section */}
